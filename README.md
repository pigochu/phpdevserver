...
- PHP 7.0.19 64bit : From [windows.php.net](http://windows.php.net/download/)
- PHP 7.1.5 64bit : From [windows.php.net](http://windows.php.net/download/)
...
- php-xdebug 2.5.3 : From [xdebug.org](http://xdebug.org/)
